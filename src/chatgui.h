...
private:
    ...
    wxBitmap _image;
    std::unique_ptr<ChatLogic> _chatLogic; //WARNING: this only belongs to Chatgui
...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { return _chatLogic.get(); } // this function returns the reference of the unique_ptr _chatlogic
